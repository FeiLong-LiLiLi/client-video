...
$(".PostBtn").click(function(){
        ...
        let text = {
         ...
         ajax('POST', "http://localhost:8004/api/monitor/now/info", 'content='+JSON.stringify(text));
...
//             ajax('POST', "http://localhost:8004/api/monitor/now/info", 'flowData=' + JSON.stringify(datajsons));
//         },20000);
//     });
// });
